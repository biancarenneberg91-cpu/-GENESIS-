...
TEMPLATES = {
    ...
    "anime": {
        ...
        "plan": {
            ...
            "roles": [
                ...
                {"name": "Otaku-Elite", "color": "#f472b6", "hoist": True},
                {"name": "Mitglied", "color": "#95a5a6", "hoist": False},
            ],
        },
    },
    "kunst": {
        ...
        "plan": {
            ...
            "roles": [
                {"name": "Owner", "color": "#e74c3c", "hoist": True},
                {"name": "Moderator", "color": "#e67e22", "hoist": True},
                {"name": "Profi-Künstler", "color": "#9b6bff", "hoist": True},
    ...
    "musik": {
        ...
        "plan": {
            ...
            "roles": [
                {"name": "Owner", "color": "#e74c3c", "hoist": True},
                {"name": "Moderator", "color": "#e67e22", "hoist": True},
                {"name": "Produzent", "color": "#9b6bff", "hoist": True},
                {"name": "Mitglied", "color": "#95a5a6", "hoist": False},
            ],
        },
    },
    "streamer": {
        ...
        "plan": {
            ...
            "roles": [
                {"name": "Streamer", "color": "#e74c3c", "hoist": True},
                {"name": "Moderator", "color": "#e67e22", "hoist": True},
                {"name": "Sub/Supporter", "color": "#9b6bff", "hoist": True},
    ...
    "tech": {
        ...
        "plan": {
            ...
            "roles": [
                {"name": "Owner", "color": "#e74c3c", "hoist": True},
                {"name": "Moderator", "color": "#e67e22", "hoist": True},
                {"name": "Senior Dev", "color": "#2dd4ee", "hoist": True},
